...
var _SubmitCountUtil = require('../util/SubmitCountUtil');

var _SubmitCountUtil2 = _interopRequireDefault(_SubmitCountUtil);
...
function updateSubmitCount() {
    submitCount++;
    var formattedCount = _SubmitCountUtil2['default'].formatSubmitCount(submitCount);
...
},{"../constants/Constants":30,"../constants/MessageType":31,"../util/SubmitCountUtil":32,"axios":1}],30:[function(require,module,exports){
"use strict";
...
},{"keymirror":27}],32:[function(require,module,exports){
'use strict';
...
var SubmitCountUtil = function () {
    function SubmitCountUtil() {
        _classCallCheck(this, SubmitCountUtil);
    }

    _createClass(SubmitCountUtil, null, [{
        key: 'formatSubmitCount',
        value: function () {
            function formatSubmitCount(submitCount) {
                if (submitCount < 10000) {
                    return (0, _numeral2['default'])(submitCount).format('0,0');
                } else {
                    return (0, _numeral2['default'])(submitCount).format('0.0a');
                }
            }

            return formatSubmitCount;
        }()
    }]);

    return SubmitCountUtil;
}();

exports['default'] = SubmitCountUtil;
